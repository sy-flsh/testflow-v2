...
export function TopHeader() {
  return (
    <header className="tf-top-header fixed inset-x-0 top-0 z-30 flex h-14 items-center border-b border-[var(--border-default)] bg-white px-5">
      <Link
        href="/dashboard"
        className="tf-link-reset flex items-center gap-2"
      >
